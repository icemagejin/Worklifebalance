...
def create_poster(bg_path, output_path, data):
    ...
    # ========== 顶部区域：淡白渐变（只在文字区域）==========
    # 顶部 450px 高度的渐变（从淡白到透明）
    create_gradient_area(draw, 0, 0, POSTER_WIDTH, 500, 
                         (255, 255, 255, 120),  # 顶部：淡白
                         (255, 255, 255, 0))    # 底部：透明
    
    # ========== 底部区域：淡白渐变 ==========
    create_gradient_area(draw, 0, POSTER_HEIGHT - 350, POSTER_WIDTH, 350,
                         (255, 255, 255, 0),      # 顶部：透明
                         (255, 255, 255, 100))    # 底部：淡白
...
if __name__ == "__main__":
    ...
    create_poster("bg-new.jpg", "test_poster_v3.jpg", data)